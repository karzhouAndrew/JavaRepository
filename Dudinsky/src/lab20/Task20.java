...
public class Task20 {
    public static void main(String[] args) {
        String givenStr = "0x, уж эта (0X!!!) тестовая 0x5fстрока 042715, содержащая 9842105 десятичные, 032517 восьмеричные и 0X52D7A12BE, шестнадцатеричные -0x23ca8; литералы и не только f8b26cd5  -0X5D.";
