...
public class Add4 {
    public static void main(String[] args) {
        ...
        int figure2 = medium % 10;
        medium = (number - number % 100) / 100;
        int figure3 = medium % 10;
        if (((figure1 == figure2) && (figure2 == figure3)) || ((figure1 == (figure2 + 1)) && (figure2 == (figure3 + 1)))) {
            System.out.println("Данное число счастливое");
        } else {
            if (number == 781 || number == 302 || number == 409 || number == 981) {
