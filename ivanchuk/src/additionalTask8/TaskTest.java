...
public class TaskTest {
    public static void main(String[] args) {
        ...
        System.out.println("Количество гласных: " + AdditionalTask8.consonantQuantity(text));
        System.out.println("Количество согласных: " + AdditionalTask8.vowelsQuantity(text));
        StringBuilder[] arrayOffers = AdditionalTask8.offersSearch(text);
        for (StringBuilder offers : arrayOffers) {
            System.out.println(offers);
        }
        System.out.println("Количество пробелов: " + AdditionalTask8.spaceQuantity(text));
        System.out.println("Количество абзацев: " + AdditionalTask8.paragraphsQuantity(text));
        System.out.println(AdditionalTask8.textWithoutSpace(text));
    }
}
