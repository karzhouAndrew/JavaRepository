...
public class TimeTest {
    public static void main(String[] args) {
        ...
        System.out.println("Полное количество секунд первого отрезка времени: " + interval1.getAllSeconds());
        System.out.println("Полное количество секунд второго отрезка времени: " + interval2.getAllSeconds());
